...
Response curve of first figure indicates a system where the simulated car approaches the target velocity smoothly without overshoot or jerk. Vibrations in thrust force is minimised as shown in second figure.
